    ...
    return (
        <article className="w-full max-w-sm shadow-xl border border-secondary rounded-lg transition-transform duration-200 transform hover:scale-105 justify-between">
            ...
            <div className="flex flex-col items-center h-full p-5">
                ...
                <Link href={`/products/${id}`} aria-label="Check this product" className="bg-secondary hover:bg-tertiary focus:ring-4 focus:outline-none focus:ring-secondary font-medium rounded-lg text-sm px-5 py-2.5 text-center text-white flex items-center mt-4">
